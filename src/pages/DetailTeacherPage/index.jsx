...
const rating_content_1= studentRating.map(i=>i.rating_content_1).reduce((a, b) => a + b, 0)
const rating_content_2= studentRating.map(i=>i.rating_content_2).reduce((a, b) => a + b, 0)
const rating_content_3= studentRating.map(i=>i.rating_content_3).reduce((a, b) => a + b, 0)
const rating_content_4= studentRating.map(i=>i.rating_content_4).reduce((a, b) => a + b, 0)
return (
    < >
        {teacher &&
                            ...
                            <div className="column  info-teacher-detail ">
                                ...
                                <div className="columns ml-3  subtitle " id='teacher-detail-info_sub-title'>
                                    <div className="detail-info-left">
                                        ...
                                        <p className='is-size-6'>{avg}/5 ({studentRating.length} đánh giá)</p>
