...
function StudentRatingDetailForm() {
    ...
    const handleResetJudge = (item) => {
        if(item.countBadJudge===0){
            toast.warning('Đánh giá này chưa bị báo xấu!', {
                position: "bottom-right",
            })
        }
        else{
    ...
    const handleDelete = (id) => {
        // deleteStudentRating(id, dispatch, axiosJWT, accessToken)
                        ...
                        <div className="columns is-multiline "
                            ...
                            <div style={{
                                ...
                                {studentRating.countBadJudge > 0 ?
                                    (
                                        <button className='button is-danger'>Đánh giá xấu lần {studentRating.countBadJudge} </button>
                                    ) : (<></>)
                                }
                            </div>
                            <div className='columns is-multiline'
                                ...
                                <div className="column is-4">
                                    ...
                                    <input
                                        ...
                                        id='Ngày cập nhật'
                                        readOnly={true}
                                        value={moment(studentRating.updatedAt).format('DD/MM/YYYY HH:mm')}
                                    />
                                </div>
                                <div className="column is-4">
