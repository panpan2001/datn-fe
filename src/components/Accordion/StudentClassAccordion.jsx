...
import cancelRegisterDemoCourse from "../../redux/actions/DemoCourse/CancelRegisterDemoCourse";
import createAxiosJWT from "../../utils/createInstance";
import { cancelRegisterDemoCourseStart, cancelRegisterDemoCourseSuccess } from "../../redux/slices/DemoCourse/cancelRegisterDemoCourse";
...
const StudentClassAccordion = ({ data }) => {
  ...
  const handleCancelCourse=()=>{
    cancelRegisterDemoCourse(data._id,dispatch,axiosJWT,accessToken)
    setShow("none")
  }
